<template>
  <div
    class="bg-white text-black flex flex-col items-center pt-16 lg:pt-0 lg:justify-center p-8 h-screen"
  >
    <div class="flex flex-col items-center mb-3 lg:mb-5">
      <h1 class="text-3xl font-bold tracking-normal">SmallToolz</h1>
    </div>
    <div class="mt-1 p-2 lg:p-2 pb-2 shadow-xl border-t-2 lg:shadow-none lg:border-none">
      <div class="flex flex-col items-center">
        <img src="../../assets/qr_cde.jpg" class="w-40 lg:w-80" />
        <p class="whitespace-pre-wrap break-words text-center lg:text-xl">
          扫描上方二维码。关注微信公众号，<br class="lg:hidden" />发送关键字
      ...
      <div class="w-full flex justify-center p-2">
        <el-button
          type="primary"
          class="btn-class text-md xl:text-lg font-bold text-center p-4 rounded-sm lg:rounded-lg cursor-pointer lg:p-6"
          @click="loginPage"
          :disabled="inputCode === ''"
          >公众号登录</el-button
        >
    ...
    <span
      class="whitespace-pre-wrap w-full text-center lg:w-2/5 mt-5 lg:mt-10 lg:text-xl text-gray-500 hover:text-black"
      >SmallToolz 提供广泛的 AI
