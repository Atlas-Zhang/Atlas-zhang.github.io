...
<template>
    <div class="excel-page h-full flex-col flex justify-start">
       ...
       <el-tabs 
        ...
        <el-tab-pane 
            :label="item[0]" v-for="(item,index) in globalData.sheets" 
            :key="index" >
        ...
        <div class="bg-gray-600 rounded w-17/18 mt-5  other-height flex max-h-full h-2/5">
            <div class=" bg-blue-900 m-3 rounded w-1/3 flex justify-center items-center">
                <div class="font-mono w-3/4 flex flex-col justify-center  items-start h-full text-xs">
                    <div class="flex justify-center w-hull">
                    <span class="  text-white font-normal  text-sm  w-2/5 inline-flex items-center">更改表名</span>
                    <el-input
                        class="input-class"
                    ...
                    <div  class="h-50 mt-2 flex items-center">
                        ...
                        <el-tooltip
                            ...
                            content="复制 SQL"
                            placement="bottom">
                        <el-icon class="text-xl" color="rgba(255,255,255,0.6)" @click="copyMessage"><CopyDocument /></el-icon>
                        </el-tooltip>
                    </div>
